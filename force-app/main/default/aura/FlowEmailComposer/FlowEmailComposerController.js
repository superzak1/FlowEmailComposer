({
      ...
      if (state === "SUCCESS") {
        ...
        templates.forEach(function (template, index) {
          ...
          if (existingFolders.length == 0) {
            ...
            folder.Name =
              template.hasOwnProperty("Folder") &&
              template.Folder.hasOwnProperty("Name") &&
              !$A.util.isEmpty(template.Folder.Name)
  ...
  changeBody: function (component, event, helper) {
    component.set("v.showSpinner", true);
    helper.getEmailTemplateBody(component.get("v.selTemplateId"), component.get("v.whatId"), component, helper);
  },
